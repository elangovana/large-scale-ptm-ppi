        ...
        expected = [
            {
                ...
                'sentence_raw': '15d-PGJ2 did not block nuclear translocation or DNA-binding activity of the transcription factor NFkappaB, but it did inhibit the activity of an NFkappaB reporter construct, suggesting that the mechanism of suppression of microglial iNOS by 15d-PGJ2 may involve interference with NFkappaB transcriptional activity in the nucleus',
                'sentence_anonymised': ' _CHEMICAL_  did not block nuclear translocation or DNA-binding activity of the transcription factor  _GENE-N_, but it did inhibit the activity of an NFkappaB reporter construct, suggesting that the mechanism of suppression of microglial iNOS by 15d-PGJ2 may involve interference with NFkappaB transcriptional activity in the nucleus',
                'label': 'NEGATIVE',
                'participant1_id': 'T4',
                'participant1': {
                    'abstract_id': '10200320',
