...
class Builder:
    ...
    def get_preprocessor(self):
        ...
        preprocessor = TransformerBertTokeniser(max_feature_len=self._max_seq_len, tokeniser=self._tokenisor)
    ...
    def get_val_dataset(self):
        if self._val_dataset is None:
            self._val_dataset = self.dataset_factory.get_dataset(self.val_data, preprocessors=self.get_preprocessor())
