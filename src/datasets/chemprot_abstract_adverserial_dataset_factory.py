...
from datasets.chemprot_adverserial_label_mapper import ChemprotAdverserialLabelMapper
...
class ChemprotAbstractAdverserialDatasetFactory(BaseDatasetFactory):
    ...
    def get_label_mapper(self, data=None, preprocessor=None, **kwargs):
        return ChemprotAdverserialLabelMapper()
